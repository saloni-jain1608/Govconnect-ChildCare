trigger CLQ_StaffRecordTrigger on CLQ_Staff_Record__c (after delete, after insert, after undelete, after update, before delete, before insert, before update) {
if(ExecutionControlSetting__c.getInstance(userinfo.getuserId()).Run_Trigger__c){    
    CLQ_StaffRecordTriggerHandler Handler = new CLQ_StaffRecordTriggerHandler (
