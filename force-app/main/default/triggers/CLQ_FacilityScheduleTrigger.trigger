...
*
*/
trigger CLQ_FacilityScheduleTrigger on CLQ_Facility_Schedule__c (after delete, after insert, after undelete, after update, before delete, before insert, before update) {
if(ExecutionControlSetting__c.getInstance(userinfo.getuserId()).Run_Trigger__c){
    CLQ_FacilityScheduleTriggerHandler Handler = new CLQ_FacilityScheduleTriggerHandler (
