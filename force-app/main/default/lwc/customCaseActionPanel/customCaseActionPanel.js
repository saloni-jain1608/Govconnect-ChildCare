...
const FIELDS = [
    'CLQ_Case_Custom__c.CLQ_Case_Custom_Record_Type_API__c',
];

export default class CustomCaseActionPanel extends LightningElement {
    @api recordId;
    @api objectApiName = 'CLQ_Case_Custom__c';
    @api objectLabel;
    @track actions = [];
    @track CLQ_Case_Custom;
    ...
    get name() {
        return this.CLQ_Case_Custom.fields.CLQ_Case_Custom_Record_Type_API__c.value;
    }
